...
# helper function to fix longitude
...
# helper function to find the top line of data in World Ocean Atlas txt file
...
# function to port data from World Ocean Atlas txt file to Pandas DF    
...
# print summmary information about each vector
